...
HTML5Node inputType(str idTag,boolean())	=	select(id(idTag),
													onchange("myFunction()"),
...
// *
str expr2js(mul(AExpr l, AExpr r))
  = expr2js(l) + "*" + expr2js(l);
// /
str expr2js(div(AExpr l, AExpr r))
  = expr2js(l) + "/" + expr2js(r);
// +
str expr2js(add(AExpr l, AExpr r))
  = expr2js(l) + "+" + expr2js(r);
// -
str expr2js(sub(AExpr l, AExpr r))
  = expr2js(l) + "-" + expr2js(r);
// <
str expr2js(lt(AExpr l, AExpr r))
  = expr2js(l) + "\<" + expr2js(r);
// <=
str expr2js(leq(AExpr l, AExpr r))
  = expr2js(l) + "\<=" + expr2js(r);
// >
str expr2js(gt(AExpr l, AExpr r))
  = expr2js(l) + "\>" + expr2js(r);
// >=
str expr2js(geq(AExpr l, AExpr r))
  = expr2js(l) + "\>=" + expr2js(r);

str expr2js(not(AExpr e))
	= "!" + expr2js(e);  

str expr2js(or(AExpr l, AExpr r))
  = expr2js(l) + " || " + expr2js(r);

str expr2js(and(AExpr l, AExpr r))
  = expr2js(l) + " && " + expr2js(r);
 
str expr2js(equal(AExpr l, AExpr r))
  = expr2js(l) + "==" + expr2js(r); 
  
str expr2js(notEqual(AExpr l, AExpr r))
  = expr2js(l) + "!=" + expr2js(r); 
